...
//   const [selectedHead, setSelectedHead] = useState(null); // main category
// const [selectedSubs, setSelectedSubs] = useState([]);   // multiple sub-options
...
//           combination: {
//             create: selectedSubs.map((subld) => ({
//               recipe_id:"+",
//               combination_id:{id:subld},
//             })),
//             update: [],
//             delete: [],
//           },
...
//   useEffect(() => {
//   console.log("Full recipeList:", recipeList);
// }, [recipeList]);

//   useEffect(() => {
//   if (recipeList?.data?.length > 0) {
//     console.log("RecipeList item:", recipeList.data[0]);
//   }
// }, [recipeList]);
...
//                 </Button>
//               </div>
//               {/* First: Select a main head (combination) */}
// <div className="mt-2 flex flex-wrap gap-2">
//   {combinationList?.data.map((head) => (
//     <Card
//       key={head.id}
//       className={`w-fit p-3 cursor-pointer ${
//         selectedHead?.id === head.id ? "bg-blue-200" : ""
//       }`}
//       onClick={() => {
//         setSelectedHead(head);      // choose this head
//         setSelectedSubs([]);        // reset sub selections
//       }}
//     >
...
// {/* Second: Show sub-options when a head is selected */}
// {selectedHead && (
//   <div className="mt-4">
//     <Title>Choose from {selectedHead.title}</Title>
...
//             key={sub.id}
//             className={`w-fit p-3 cursor-pointer ${
//               selectedSubs.includes(sub.id) ? "bg-green-200" : ""
//             }`}
//             onClick={() => {
//               // Toggle multiple selections
//               setSelectedSubs((prev) =>
//                 prev.includes(sub.id)
//                   ? prev.filter((s) => s !== sub.id) // remove
//                   : [...prev, sub.id]               // add
//               );
//             }}
//           >
...
//     {/* Show joined selections */}
//     {selectedSubs.length > 0 && (
//       <Text className="mt-3">
//         Selected:{" "}
//         {recipeList?.data
//           .filter((r) => selectedSubs.includes(r.id))
//           .map((r) => r.title)
//           .join(" / ")}
//       </Text>
//     )}
